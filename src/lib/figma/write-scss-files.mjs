...
const prependComment = (content) => {
  const comment = `/* This file is autogenerated from the Figma API. Do not adjust or edit */\n\n`;
...
export const writeFiles = async (files, content) => {
  ...
  await Promise.all(
    Object.entries(files).map(async ([filePath]) => {
      const newContent = prependComment(content[filePath]);
